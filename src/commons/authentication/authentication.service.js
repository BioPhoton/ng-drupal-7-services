(function () {
    ...
    function AuthenticationService($rootScope, DrupalApiConstant, AuthenticationServiceConstant, AuthenticationChannel, SystemResource, UserResource, $cookies, $http, $q) {
        ...
        var auth_provider = DrupalApiConstant.auth_providers.basic_auth,
            userIsConected,
        ...
        function getConnectionState() {
            return (userIsConected) ? true : false;
        };
         ...
         *
         * @param {String} x_csrf_token value
         * @param {String} authorization ()
         *
         **/
        function setAuthenticationHeaders(x_csrf_token, authorization) {


            var newData = {
                'Authorization' : (authorization)?authorization:x_csrf_token,
            ...
            if(authenticationHeaders) {
                if(authenticationHeaders.Authorization != newData.Authorization && authenticationHeaders['X-CSRF-TOKEN']!= newData['X-CSRF-TOKEN']) {
